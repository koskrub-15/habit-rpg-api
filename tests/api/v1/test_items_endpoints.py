...
async def test_get_item_by_id(
    ...
    response_not_found = await client.get("/api/v1/items/99999")
...
async def test_delete_item(
    ...
    response_not_found = await client.delete("/api/v1/items/99999")
    assert response_not_found.status_code == 404
    assert "detail" in response_not_found.json()
...
async def test_get_item_count(
    ...
    response_initial = await client.get("/api/v1/items/count")
...
async def test_check_item_exists(
    ...
    response_exists = await client.get(f"/api/v1/items/{item_id}/exists")
    assert response_exists.status_code == 200
    assert response_exists.json()["exists"] is True

    response_not_exists = await client.get("/api/v1/items/99999/exists")
